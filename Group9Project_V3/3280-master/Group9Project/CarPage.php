...
if (!empty($_POST)) {
    ...
    if(false){
        ...
        $fb->setBrand($_POST["brand"]);
        $fb->setModel($_POST["model"]);
        $fb->setPrice($_POST["price"]);
        $fb->setDate($_POST["date"]);
        $fb->setAvailability($_POST["availability"]);
